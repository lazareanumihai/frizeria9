...
## Redesign Program de Lucru - Weekly Calendar (Completed)
- [x] Create DayColumn component for weekly calendar display
  - [x] Display day name and date in header
  - [x] Add "Zi Liberă" toggle switch
  - [x] Show hourly time slots (08:00-20:00)
  - [x] Color coding: green (available), red (blocked), gray (day off)
  - [x] Click to toggle hour blocked/available
  - [x] Disable past dates/hours
- [x] Create BarberSchedulePage component
  - [x] Header with title and barber selector
  - [x] Week navigation (Today, Previous, Next)
  - [x] Display week date range
  - [x] Legend showing color meanings
  - [x] 7-column grid layout for days
  - [x] Responsive design with horizontal scroll
- [x] Update backend integration
  - [x] Ensure barberAvailability table supports blocked_hours storage
  - [x] Update endpoints to handle hour-level blocking
  - [x] Modify getAvailableSlots to respect blocked hours
- [x] Integrate into admin navigation
  - [x] Add "Program de Lucru" link in admin header
  - [x] Create /admin/schedule route
  - [x] Update App.tsx with new route
- [x] Test end-to-end functionality
  - [x] Select barber and navigate weeks
  - [x] Toggle day off for a day
  - [x] Block/unblock individual hours
  - [x] Verify blocked hours excluded from public booking
  - [x] Test past dates are disabled
